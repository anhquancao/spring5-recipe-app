...
public class IngredientController {
    ...
    public IngredientController(RecipeService recipeService, IngredientService ingredientService, UnitOfMeasureService unitOfMeasureService, UserService userService) {
